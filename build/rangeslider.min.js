(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}(g.webit || (g.webit = {})).RangeSlider = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
...
exports.default = createElIfNotExists;
...
exports.default = getElementOuterDimensions;
...
var _boundry = require('./boundry');

var _boundry2 = _interopRequireDefault(_boundry);

var _getElementOffset = require('./getElementOffset');

var _getElementOffset2 = _interopRequireDefault(_getElementOffset);

var _getElementOuterDimensions = require('./getElementOuterDimensions');

var _getElementOuterDimensions2 = _interopRequireDefault(_getElementOuterDimensions);

var _isBetween = require('./isBetween');

var _isBetween2 = _interopRequireDefault(_isBetween);

var _createSwipeEl = require('./createSwipeEl');

var _createSwipeEl2 = _interopRequireDefault(_createSwipeEl);

var _createElIfNotExists = require('./createElIfNotExists');

var _createElIfNotExists2 = _interopRequireDefault(_createElIfNotExists);
...
function RangeSlider(el, config) {
    ...
    this.swipeEl = (0, _createSwipeEl2.default)(this.el);
    this.pinEl = (0, _createElIfNotExists2.default)(this.el, 'rangeslider__pin', 'div');
    this.trackEl = (0, _createElIfNotExists2.default)(this.el, 'rangeslider__track', 'div');
    this.trackFillEl = (0, _createElIfNotExists2.default)(this.trackEl, 'rangeslider__track-fill', 'div');
...
RangeSlider.prototype = {
    createSwipe: function createSwipe(el) {
        return new _swipe2.default(el, {
    ...
    setEvents: function setEvents() {
        ...
        this.swipe.on('start', function (ev) {
            return _this.handleStart(ev);
        });
        this.swipe.on('move', function (ev) {
            return _this.handleMove(ev);
        });
        this.swipe.on('end', function (ev) {
            return _this.handleEnd(ev);
        });
        this.swipe.on('tap', function (ev) {
            return _this.handleTap(ev);
        });
    ...
    resize: function resize(isInitialSetup) {
        this.elOffset = (0, _getElementOffset2.default)(this.el);
        this.elDimensions = (0, _getElementOuterDimensions2.default)(this.el);
        this.pinDimensions = (0, _getElementOuterDimensions2.default)(this.pinEl);
    ...
    handleWindowResize: function handleWindowResize(ev) {
        var _this2 = this;

        console.log("handleWindowResize");
        clearTimeout(this.wrt);
        this.wrt = setTimeout(function () {
     ...
     */
    handleStart: function handleStart(ev) {
    ...
    handleEnd: function handleEnd(ev) {
        if (!this.isMove) {
            return;
        }
        this.position.x = this.boundryX(this.position.x + this.offset.x);
    ...
    handleTap: function handleTap(ev) {
        /**
    ...
    validateMoveStartPosition: function validateMoveStartPosition(x, y) {
        ...
        console.log((0, _isBetween2.default)(x, this.position.x - this.safePadding, this.position.x + this.pinDimensions.width + this.safePadding));

        return (0, _isBetween2.default)(x, this.position.x - this.safePadding, this.position.x + this.pinDimensions.width + this.safePadding) && (0, _isBetween2.default)(y, this.position.y - this.safePadding, this.position.y + this.pinDimensions.height + this.safePadding);
    },
    ...
    boundryX: function boundryX(x) {
        return (0, _boundry2.default)(x, 0, this.elDimensions.width - this.pinDimensions.width);
    },
    boundryY: function boundryY(y) {
        return (0, _boundry2.default)(y, 0, this.elDimensions.height - this.pinDimensions.height);
    },
    vizualize: function vizualize() {
        this.setTransform(this.pinEl, this.boundryX(this.position.x + this.offset.x),
        //this.boundryY(this.position.y + this.offset.y),
        0);

        this.trackFillEl.style.width = this.boundryX(this.position.x + this.offset.x) + 'px';
    },
    setTransform: function setTransform(el, x, y) {
...
},{"./boundry":2,"./createElIfNotExists":3,"./createSwipeEl":4,"./getElementOffset":5,"./getElementOuterDimensions":6,"./isBetween":7,"swipe":1}]},{},[8])(8)
});
